...
export function Stats() {
  return (
    <section id="om" className="scroll-mt-20 bg-ink px-[6vw] py-[88px]">
      <div className="mx-auto grid max-w-[980px] grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-[56px]">
        <div>
          ...
          {stats.map((stat, i) => (
            <div
              ...
              className={`flex items-baseline gap-[18px] ${
                i < 2 ? "border-b border-sand/10 pb-[14px]" : "pb-1"
              }`}
            >
              <span className="min-w-[96px] font-display text-[44px] font-medium leading-none text-amber">
                {stat.value}
              </span>
