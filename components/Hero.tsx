...
export function Hero() {
  return (
    <section className="grid grid-cols-1 bg-sand md:grid-cols-[1.04fr_.96fr]">
      <div className="flex flex-col justify-center px-[7vw] pb-[72px] pt-[84px] md:px-[6vw] md:py-[120px]">
        <p className="mb-6 text-[11px] font-medium uppercase tracking-[0.24em] text-amber">
          Vintervelvære&nbsp;·&nbsp;Vitenskapelig fundert
        </p>
        <h1 className="mb-[26px] font-display text-[clamp(44px,4.4vw,64px)] font-normal leading-[1.06] text-ink">
          Lysets liv,
          <br />
          gjennom de
          <br />
        ...
        <p className="mb-9 max-w-[440px] text-[17px] leading-[1.7] text-body">
          Vitenskapelig funderte produkter for kropp og søvn når dagslyset blir
          borte. Vi åpner høst 2025 — bli blant de første.
        </p>
        <SignupForm variant="light" id="tilgang" className="max-w-[440px] scroll-mt-28" />
        <p className="mt-4 text-xs text-ink/42">
          Ti prosent på din første bestilling.
        </p>
      </div>
      <div className="relative min-h-[300px] overflow-hidden bg-ink md:min-h-[560px]">
        <Image
          src="/images/hero.jpg"
          alt=""
          fill
